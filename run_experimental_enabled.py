...
# Enable feature flags before importing spellchecker
...
with open("scratch_experimental_enabled_out.json", "w", encoding="utf-8") as f:
    json.dump(output, f, ensure_ascii=False, indent=2)

print("EXPERIMENTAL_ENABLED_COMPLETED")
