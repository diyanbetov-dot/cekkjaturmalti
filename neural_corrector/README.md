...
.\.venv\Scripts\python.exe -m neural_corrector.dataset.synthetic_corruption
...
Measured baseline results are in `docs/baseline_results.md`; full machine
reports are in `experiments/`.
